...
function Contact() {
  ...
  if (submitted) {
    return (
      <>
        <Grid container alignItems="center" minHeight="76.4vh">
          <Grid item xs={12} >
  ...
  return (
    <Box sx={{height:"80vh"}}>
      <Container component="form" action={FORM_ENDPOINT} method="POST" maxWidth="sm" sx={{paddingY:"40px"}}>
        <Stack spacing={2}>
          <Typography variant="h4" fontWeight="medium" textAlign="center" paddingBottom={5}>Wanna get in touch?<br/>Feel free to shoot me a message!</Typography>
          <Box>
            <TextField
              name="name"
              label="Name"
